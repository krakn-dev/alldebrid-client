...
## Override Rule
Project-specific rules in `CLAUDE.md` override workstation defaults for this repository. In particular, keep this repo's documented commit, changelog, and release conventions unless Ben explicitly changes them.
